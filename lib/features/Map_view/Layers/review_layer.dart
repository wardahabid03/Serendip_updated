...
class ReviewLayer extends MapLayer {
  ...
  Future<BitmapDescriptor> _createCustomMarker(ReviewModel review) async {
    ...
    // Bubble background
    final bubbleRect =
        RRect.fromLTRBR(0, 0, 250, 110, const Radius.circular(30));
              ...
              builder: (context, setState) {
                return FutureBuilder<String>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    final currentReview = reviewProvider.reviews.firstWhere(
                        ...
                        Expanded(
                          child: ListView(
                            ...
                            children: [
                              ...
                              ListTile(
                                ...
                                leading: Consumer<ProfileProvider>(
                                  builder: (context, profileProvider, child) {
                                    return FutureBuilder<String?>(
                                      future: profileProvider.getProfileImageById(currentReview.userId),
                                      builder: (context, snapshot) {
                                        final image = snapshot.data != null
                                ...
                                title: Text(currentReview.userName),
                                subtitle: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    Text(
                                      _formatTimestamp(currentReview.timestamp),
                              ...
                              ...currentReview.comments.map((comment) {
                                return ListTile(
                                  ...
                                  leading: Consumer<ProfileProvider>(
                                    builder: (context, profileProvider, child) {
                                      return FutureBuilder<String?>(
                                        future: profileProvider.getProfileImageById(comment['userId']),
                                        builder: (context, snapshot) {
                                          final img = snapshot.data != null
                                              ? NetworkImage(snapshot.data!)
                                              : AssetImage("assets/images/avatar.png") as ImageProvider;
                                          return CircleAvatar(radius: 20, backgroundImage: img);
                                        },
                                      );
                                    },
                                  ),
                              ...
                              // ➕ Add Comment
                              Text('Add yours', style: TextStyle(color: Colors.grey[600])),
                              SizedBox(height: 8),
                                    ...
                                    child: ElevatedButton(
                                      onPressed: () async {
                                        ...
                                        if (commentText.isNotEmpty) {
                                          ...
                                          // Force refresh of UI by calling setState
                                          setState(() {});
                                        }
                                      },
